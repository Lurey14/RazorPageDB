...
builder.Services.AddDbContext<RazorPractica.Data.TareaDbContext>(options =>
...
// este es el tercero corregido
using Microsoft.EntityFrameworkCore;
using RazorPractica.Data;
using RazorPractica.Interfaces;
using RazorPractica.Seeders;
